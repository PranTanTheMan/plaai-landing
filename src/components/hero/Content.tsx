  ...
  return (
    <MaxWidthWrapper className="relative z-20 flex flex-col items-center justify-center pb-12 pt-24 md:pb-36 md:pt-36">
      <motion.div
        ...
        className="relative"
      >
        <GlowingChip>Pro-quality headshots in seconds 🎉</GlowingChip>
      </motion.div>
      <motion.h1
        initial={{
          y: 25,
      ...
      >
        Generate studio-quality professional headshots for LinkedIn, resumes,
        and company websites in minutes. No photographer, no studio, no hassle.
      </motion.p>
      <motion.div
        initial={{
          y: 25,
