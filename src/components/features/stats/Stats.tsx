      ...
      <div className="relative z-20 mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="flex flex-col items-center justify-center sm:flex-row">
          <Stat
            num={98}
            suffix="%"
            subheading="Client satisfaction rate with their AI generated headshots"
          />
          <div className="h-[1px] w-12 bg-zinc-600 sm:h-12 sm:w-[1px]" />
          <Stat
            num={100}
            suffix="+"
            subheading="Professional photos generated for LinkedIn users and other professional use cases"
          />
          <div className="h-[1px] w-12 bg-zinc-600 sm:h-12 sm:w-[1px]" />
          <Stat
            num={30}
            suffix="s"
            subheading="Average time to generate your perfect professional photo"
          />
        </div>
      </div>
